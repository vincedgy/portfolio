...
var SampleApp = function() {
  ...
  self.initializeServer = function() {
    ...
    self.app.post('/email', function(req, res) {
      ...
      if (emailto != '' && websitename != '' && formName != '' && formEmail != '' && formSubject != '' && formMessage != '') {
        console.log('Sending message : ' + emailto + ':' + websitename + ':' +  formName + ':' +  formEmail + ':' + formSubject + ':' + formMessage);
        // setup e-mail data with unicode symbols
        var mailOptions = {
          from: formName + '<' + formEmail + '>', // sender address
          to: emailto, // list of receivers
          subject: 'From ' + websitename + ':' + formSubject, // Subject line
          text: formMessage, // plaintext body
          html: formMessage // html body
        };
